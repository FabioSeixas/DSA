...
const myFunc = (arrayOfStrings, total = 0) => {
  if (arrayOfStrings.length < 2) return arrayOfStrings[0].length + total
  return myFunc(arrayOfStrings.slice(1, arrayOfStrings.length), arrayOfStrings[0].length + total)
}
